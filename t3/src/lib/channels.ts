 ...
 * bar has the lightness the bar is set to — which makes the colour under the
 * mark a known quantity rather than something to sample.
 */
export function markInk([L]: Triple): string {
