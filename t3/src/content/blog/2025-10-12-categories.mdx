...
We can represent it as a functor `D` from the category with three objects and three
morphisms -- the two arrows you see, plus the composite that any category gives us for
free (let's call this category `3`) -- to the category of dogs. Let's not even
