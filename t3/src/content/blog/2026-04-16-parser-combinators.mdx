...
What's it do? It's a functin that takes a string, consumes a part of the front of the string and turns that into a parsed value of type `T`; in the second entry of the tuple, we return the rest of the string.
