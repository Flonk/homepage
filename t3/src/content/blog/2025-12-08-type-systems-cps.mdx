...
is both a very mind-bending concept, as well as very common in practice!

Remember the function from last post that was generic in its return type?
...
When you put it into words it might sound a bit abstract, but in a world before
