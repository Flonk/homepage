...
Well -- if all I do in my day-to-day typescript work is writing down types and having the AI generate all the stuff in between, then isn't Haskell a better fit? I can write down very precise types, and then I have the AI generate AI slop, but it'll be very restricted AI slop, and by restricting the AI we are setting it up to stumble into correcter solutions.
