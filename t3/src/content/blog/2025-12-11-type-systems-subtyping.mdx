...
to the usua syntactic rules for subtyping like covariance in return types
...
also doesn't do subtyping (except for lifetimes), and uses traits for similar use cases as well.
