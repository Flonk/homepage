...
Let's look at the following Venn Diagram I stole off google,
which is a visual representation of the intersection of two sets:

![Venn Diagram](/assets/2025-07-24-type-intersections/venn.png)

Now, will Tomatoes be allowed to visit the round fruits club?

Yes, because it exists in the intersection of all round fruits.
