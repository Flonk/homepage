...
meaningful, and it leads to *the same* meaningful thing for different
...
tree zippers *the* most convenient way of navigating and updating trees.

Moving up and down the zipper is `O(1)`, and updating the focused element
is `O(1)` aswell! And not only that, you can use zippers to model
