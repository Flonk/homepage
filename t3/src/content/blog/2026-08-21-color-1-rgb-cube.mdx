...
<DeckCard vizProps={{ guides: true }}>
  ...
  colour your screen can display.
</DeckCard>
...
<DeckCard vizProps={{ tour: 2, guides: false }}>
  ...
  off or completely full, making those colours very distinct from one another. In fact, the corners of the cube are exactly all the *primary colours*, *secondary colours*, as well as black and white.
