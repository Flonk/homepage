...
In [post #5](/blog/2025-12-04-type-systems-system-f) I claimed that System F generics shouldn't be a huge conceptual leap.
...
In [post #8](/blog/2025-12-07-type-systems-theorems-for-free) we even looked at a very degenerate case, `error :: ∀R. String → R`,
...
>
  **Solution:** It always returns `10`.
  ...
  You must provide an argument of type `∀A. A → A`, and as discussed in [post #8](/blog/2025-12-07-type-systems-theorems-for-free),
...
As discussed in [post #8](/blog/2025-12-07-type-systems-theorems-for-free), the continuation's type `∀R. FileHandle → R` might make
