...
<SeriesNav seriesName="type systems" currentPart="25" prevPart="24" />
...
on AI output, that _you are_ the formal verification system, using "dependent" types
...
There are other paths through the cube as well, but ours is
...
I'll do another series like this one -- there's still so many topics that I
