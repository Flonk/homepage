...
If the three-sigma event happens, we know where to look, and where
to implement a fix.

This doesn't influence the time it takes to implement my feature,
but everyone benefits. It's an easy win.

Though obviously this will never fly at code review so you have to
