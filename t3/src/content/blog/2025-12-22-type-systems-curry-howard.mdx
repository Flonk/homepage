...
It's also really a really nice trick for
...
Of course, then there are the grown-ups who know both maths *and*
...
system is *also* something that can prove (or verify) mathematical theorems
for you!
...
<a name="footnote1" class="footnote"><sup>[1] There is a one concrete type `A`
...
as stated is not true, as `A` is generic. </sup></a>