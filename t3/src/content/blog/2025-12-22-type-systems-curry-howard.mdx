...
in a particularly strong variant of the lambda calculus -- like the Calculus
of Constructions that Coq is built on, or the Martin-Löf type theory underlying Agda.
