...
<DeckViz>
  ...
  <VizImage
    name="subpixels"
    src="/assets/2026-08-21-color-1-oklch/subpixels.png"
...
<DeckCard label="Wandering2" vizProps={{ tour: null, line: true, guides: true }}>
  ## A line segment through the cube is a gradient
...
<DeckCard label="Subpixels" vizProps={{ overlay: "subpixels" }}>
...
<DeckCard label="Why it matters" vizProps={{ overlay: null, line: false, guides: false }}>
