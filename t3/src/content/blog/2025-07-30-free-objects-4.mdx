...
We can define a sort of hierarchy between these three
structures that looks like so, where each arrow represents
_forgetting_ part of the original structure:
...
be familiar with the term _in-order tree traversal_ -- it's where
...
I don't know I haven't really thought it through. Maybe you can
