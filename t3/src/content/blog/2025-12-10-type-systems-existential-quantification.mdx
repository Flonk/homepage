...
Though, sloppily, the individual elements are then typed as `Object`, but yeah Java's 
existentials are very rudimentary. More accurate would be the following pseudo-Java:
...
*also* turn out to be two sides of the same coin (via the Curry-Howard isomorphism),
