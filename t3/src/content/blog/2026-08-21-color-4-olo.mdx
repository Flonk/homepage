...
>
  ...
  There are many different combinations of light that can produce the same color. Two sets of lights producing the same color are called *metamers* of each other
</DeckCard>
