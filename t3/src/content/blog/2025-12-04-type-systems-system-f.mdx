...
In most major programming languages all the generic stuff is handled at compile time,
where by the time the program runs, all the generic types have been erased and they don't
...
and there is no such distinction; remember, when you are "evaluating" lambda terms, you are just
...
Now. We have _defined_ the `apply` function; but what is its type? For this we need to bust out even
...
post is already quite long, we'll continue in [post #7](/blog/2025-12-06-type-systems-system-f2).
